...
public enum FilterGroups {
    ...
    BOW(Material.BOW), AXE(Material.DIAMOND_AXE, Material.GOLD_AXE, Material.IRON_AXE, Material.STONE_AXE, Material.WOOD_AXE),
    HOE(Material.DIAMOND_HOE, Material.GOLD_AXE, Material.IRON_HOE, Material.STONE_HOE, Material.WOOD_HOE),
    ...
    SPADE(Material.DIAMOND_SPADE, Material.GOLD_SPADE, Material.IRON_SPADE, Material.STONE_SPADE, Material.WOOD_SPADE),
